export const PlatformFacebookColorOriginal = ({ className }) => {
  return (
    <svg
      className={`platform-facebook-color-original ${className}`}
      fill="none"
      height="48"
      viewBox="0 0 48 48"
      width="48"
    ...
    >
      <g className="g" clipPath="url(#clip0_117292_4176)">
        <path
          className="path"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_117292_4176">
