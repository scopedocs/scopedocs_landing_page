export const PlatformTelegramColorOriginal = ({ className }) => {
  return (
    ...
    >
      <g className="g" clipPath="url(#clip0_117292_4096)">
        <path
          className="path"
          d="M24 48C37.2548 48 48 37.2548 48 24C48 10.7452 37.2548 0 24 0C10.7452 0 0 10.7452 0 24C0 37.2548 10.7452 48 24 48Z"
          fill="url(#paint0_linear_117292_4096)"
        />
      ...
      <defs className="defs">
        ...
        <clipPath className="clip-path" id="clip0_117292_4096">
